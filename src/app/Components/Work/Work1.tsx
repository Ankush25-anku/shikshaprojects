...
const Work1 = () => {
            ...
            <div className="cs_workink_process_heading cs_center_column position-relative">
              <div className="cs_section_heading cs_style_1 cs_mb_11 z-1">
                ...
                <h2 className="cs_section_title cs_fs_48 cs_semibold wow fadeInUp">
                  Smart School Management <br/> In Just 3 Simple Steps
                </h2>

                <p className="cs_card_desc cs_mb_22">
                  ShikshaFlow transforms traditional school ERP into a powerful WhatsApp-based system,
                  enabling instant communication, real-time updates, and seamless automation — without
  ...
  <Image
    src="/assets/img/data1.jpg"
    alt="img"
    width={438}
    height={408}
    style={{ borderRadius: "20px" }} // 👈 20px rounded corners
  />
</div>
          ...
          <div className="col-lg-6 order-lg-1">
            <div className="cs_iconbox_wrapper_2">
              ...
              <div className="cs_iconbox cs_style_2">
                ...
                <h3 className="cs_fs_24 cs_semibold cs_mb_4">
                  Setup Your School ERP
                </h3>

                <p className="mb-0">
                  Quickly onboard your school with Shiksha Flow. Configure student data, classes,
                  and communication settings in minutes with a simple and user-friendly setup process.
                </p>
              </div>
              ...
              <div className="cs_iconbox cs_style_2">
                ...
                <p className="mb-0">
                  Enable powerful WhatsApp chatbot integration to handle enquiries, share student
                  marks, homework, attendance, and school updates instantly — all in real-time.
                </p>
              </div>
              ...
              <div className="cs_iconbox cs_style_2">
                ...
                <h3 className="cs_fs_24 cs_semibold cs_mb_4">
                  Engage, Track & Automate
                </h3>

                <p className="mb-0">
                  Manage enquiries, track student performance, send alerts, and automate
                  communication — all without needing any mobile app, ensuring a seamless experience
