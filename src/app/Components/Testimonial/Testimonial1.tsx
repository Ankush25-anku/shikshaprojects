    ...
    const testimonialContent = [
        {
          ...
          title:'Ravi Kumar',
          content:'Shiksha Flow completely transformed how we handle parent communication. Earlier, we struggled with calls and apps, but now everything is automated through WhatsApp. Parents can instantly check marks, attendance, and homework. It has saved us hours of manual work every day.'
        },             
        {
          img:'/assets/img/avatar-6.jpg',
          subtitle:'Principal',
          title:'Anita Sharma',
          content:'The best part about Shiksha Flow is that parents don’t need to install any app. Everything works directly on WhatsApp, which makes it extremely convenient. Our enquiry response time has improved drastically, and communication is now faster and more efficient than ever.'
        },             
      ]; 
      ...
      <div className="container">
        <div className="cs_testimonial_slider_wrapper cs_radius_20 position-relative">
          ...
          <div className="cs_section_heading cs_style_1 cs_mb_10">
            <h2 className="cs_section_title cs_fs_24 cs_normal mb-0">
              What Schools Say About Shiksha Flow
            </h2>
          </div>
