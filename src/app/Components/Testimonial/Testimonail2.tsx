  ...
  const testimonialContent = [
    {
      ...
      title: 'Priya Sharma',
      content: 'ShikshaFlow completely transformed our school operations. Parents now receive instant updates on marks, attendance, and homework through WhatsApp. No app installation needed — it’s simple and extremely effective.'
    },
    {
      img: '/assets/img/test2.jpg',
      subtitle: 'Admissions Head',
      title: 'Rahul Verma',
      content: 'The enquiry follow-up system is a game changer. Earlier we used to miss leads, but now every enquiry is tracked and followed up automatically via WhatsApp. Our admissions have increased significantly.'
    },
    {
      img: '/assets/img/test1.jpg',
      subtitle: 'School Principal',
      title: 'Anita Reddy',
      content: 'Managing communication with parents has never been this easy. Shiksha Flow reduced our manual work and improved transparency. The WhatsApp automation makes everything fast and seamless.'
    }
  ];
        ...
        <div className="cs_section_heading cs_style_1 cs_type_1 cs_mb_60">
          <div className="cs_section_heading_left">
            ...
            <h2 className="cs_section_title cs_fs_48 cs_semibold mb-0 wow fadeInUp">
              What Schools Say About ShikshaFlow
            </h2>
          </div>
